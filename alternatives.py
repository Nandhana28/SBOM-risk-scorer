# Suggested remediation for libraries commonly flagged with restrictive/incompatible licenses.
# Where the real upstream project normally ships under a permissive license, that's noted --
# a copyleft flag on it usually means a fork/vendored copy, so "revert to upstream" is the fix.
...
DEFAULT_SUGGESTION = "Search for a permissively-licensed (MIT/Apache-2.0/BSD) alternative, or request a commercial license from the vendor."


def suggest_alternative(library):
